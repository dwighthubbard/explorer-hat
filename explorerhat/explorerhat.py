        ...
        while self.stop_event.is_set() == False:
            ...
            if ( delta <= self.transition_on ):
                ...
                self.pin.duty_cycle(round(( 100.0 / self.transition_on ) * delta))
                    ...
                    delta > self.transition_on + self.time_on and delta <= self.transition_on + self.time_on + self.transition_off ):
...
class Pin(object):
    ...
    Pin contains methods that apply to both inputs and outputs type = 'Pin'
    """
